pipeline { // Opening pipeline
    ...
    environment { // Opening environment
        ...
        NEXUS_URL = "3.147.65.25:8082/" // Double check the double slash at the end, usually it's just one: "3.88.54.126:8082/"
        // Repository where we will upload the artifact
        NEXUS_REPOSITORY = "maven-snapshot123/" // Is this the correct Nexus repository name? Sonarqube is usually a tool, not a Nexus repo. Common ones are 'maven-releases', 'maven-snapshots'.
        // Jenkins credential id to authenticate to Nexus OSS
        NEXUS_CREDENTIAL_ID = "nexus-token" // Make sure this is the exact ID configured in Jenkins Credentials.
        SCANNER_HOME = tool 'sonar-scanner' // This should be the tool name configured in Jenkins for SonarQube Scanner.
    } // Closing environment
